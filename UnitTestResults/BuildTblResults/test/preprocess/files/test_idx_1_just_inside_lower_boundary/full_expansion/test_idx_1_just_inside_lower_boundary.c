...
void test_BuildTbl_idx_1_just_inside_lower_boundary(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0x07)), (UNITY_INT)(UNITY_UINT8 )((Crc8Tbl_u8[1])), (
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_1_just_inside_lower_boundary.c" 3 4
 ((void *)0)
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_1_just_inside_lower_boundary.c"

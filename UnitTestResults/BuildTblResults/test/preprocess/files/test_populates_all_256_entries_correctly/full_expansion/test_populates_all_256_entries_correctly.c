...
# 66 "utExecutionAndResults/utUnderTest/src/Crc8.h"

# 66 "utExecutionAndResults/utUnderTest/src/Crc8.h"
uint8_t Crc8_Calc_u8(const uint8_t *dataPtr, size_t dataLen);
# 110 "utExecutionAndResults/utUnderTest/src/Crc8.h"
...
# 63 "utExecutionAndResults/utUnderTest/src/BuildTbl.h"
...
void Crc8_Calc_u8_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);

void Crc8_Calc_u8_CMockStopIgnore(void);


void Crc8_Calc_u8_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);


void Crc8_Calc_u8_CMockExpectAndReturn(UNITY_UINT cmock_line, const uint8_t* dataPtr, size_t dataLen, uint8_t cmock_to_return);
...
void Crc8_Calc_u8_CMockExpectWithArrayAndReturn(UNITY_UINT cmock_line, const uint8_t* dataPtr, int dataPtr_Depth, size_t dataLen, uint8_t cmock_to_return);

void Crc8_Calc_u8_CMockIgnoreArg_dataPtr(UNITY_UINT cmock_line);

void Crc8_Calc_u8_CMockIgnoreArg_dataLen(UNITY_UINT cmock_line);


void Crc8_Upd_u8_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);

void Crc8_Upd_u8_CMockStopIgnore(void);


void Crc8_Upd_u8_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);


void Crc8_Upd_u8_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8_t crc, uint8_t dataByte, uint8_t cmock_to_return);
...
void Crc8_Upd_u8_CMockIgnoreArg_crc(UNITY_UINT cmock_line);

void Crc8_Upd_u8_CMockIgnoreArg_dataByte(UNITY_UINT cmock_line);
...
void EnsureTblInit_CMockExpect(UNITY_UINT cmock_line);
...
void CalcByte_u8_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);

void CalcByte_u8_CMockStopIgnore(void);


void CalcByte_u8_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);


void CalcByte_u8_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8_t crc, uint8_t dataByte, uint8_t cmock_to_return);
...
void CalcByte_u8_CMockIgnoreArg_crc(UNITY_UINT cmock_line);

void CalcByte_u8_CMockIgnoreArg_dataByte(UNITY_UINT cmock_line);
...
void test_BuildTbl_populates_all_256_entries_correctly(void) {
  ...
  for(size_t i = 0; i < 256; i++) {
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((golden_table[i])), (UNITY_INT)(UNITY_UINT8 )((Crc8Tbl_u8[i])), (
# 26 "utExecutionAndResults/utUnderTest/test/test_populates_all_256_entries_correctly.c" 3 4
   ((void *)0)
# 26 "utExecutionAndResults/utUnderTest/test/test_populates_all_256_entries_correctly.c"

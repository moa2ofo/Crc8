# 0 "utExecutionAndResults/utUnderTest/test/test_populates_all_256_entries_correctly.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_populates_all_256_entries_correctly.c"
# 1 "utExecutionAndResults/utUnderTest/src/BuildTbl.h" 1

#define TEST_BUILDTBL_H 

# 1 "utExecutionAndResults/utUnderTest/src/Crc8.h" 1
/******************************************************************************/
/* Crc8.h                                                                     */
/******************************************************************************/
...
# 8 "utExecutionAndResults/utUnderTest/src/Crc8.h" 2
...
# 9 "utExecutionAndResults/utUnderTest/src/Crc8.h" 2
...
# 5 "utExecutionAndResults/utUnderTest/src/BuildTbl.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/Crc8_priv.h" 1
/******************************************************************************/
/* Crc8_priv.h                                                                */
/******************************************************************************/
 ...
 *
 * @par Design notes
 * The table is built once on demand to avoid startup overhead when CRC is not
 * used. The update rule is table-driven: `crc' = table[crc XOR dataByte]`
 *
 * @par Reentrancy / thread-safety
 * The functions operate on static state (table + init flag). If multiple
 * threads might call CRC APIs simultaneously for the first time, protect the
 * first-time initialization (or provide a dedicated init call executed
 * single-threaded).
 */

/* Private (cfile-static) variables (Table 6: Global static -> N/A +
 * PascalCasing + _datatype) */

/**
 * @brief CRC-8 lookup table (256 entries).
 *
 * @details
 * The table stores the precomputed CRC-8 transform for all possible 8-bit
 * indices. It is generated by @ref BuildTbl and later used by @ref CalcByte_u8
 * to update the CRC in O(1) per processed byte.
 */
...
# 6 "utExecutionAndResults/utUnderTest/src/BuildTbl.h" 2
 ...
 * ISO C Standard:  7.17  Common definitions  <stddef.h>
 */
# 8 "utExecutionAndResults/utUnderTest/src/BuildTbl.h" 2
...
# 9 "utExecutionAndResults/utUnderTest/src/BuildTbl.h" 2
...
# 2 "utExecutionAndResults/utUnderTest/test/test_populates_all_256_entries_correctly.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_populates_all_256_entries_correctly/mock_Crc8.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_populates_all_256_entries_correctly/mock_Crc8.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/Crc8.h" 1
/******************************************************************************/
/* Crc8.h                                                                     */
/******************************************************************************/
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_populates_all_256_entries_correctly/mock_Crc8.h" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_populates_all_256_entries_correctly.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_populates_all_256_entries_correctly/mock_Crc8_priv.h" 1
/* AUTOGENERATED FILE. DO NOT EDIT. */
...
/* Crc8_priv.h                                                                */
/******************************************************************************/
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_populates_all_256_entries_correctly/mock_Crc8_priv.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_populates_all_256_entries_correctly.c" 2
...
void test_BuildTbl_populates_all_256_entries_correctly(void) {
  const uint8_t golden_table[256] = {
  ...
  for(size_t i = 0; i < 256; i++) {
    TEST_ASSERT_EQUAL_UINT8(golden_table[i], Crc8Tbl_u8[i]);
  }
}

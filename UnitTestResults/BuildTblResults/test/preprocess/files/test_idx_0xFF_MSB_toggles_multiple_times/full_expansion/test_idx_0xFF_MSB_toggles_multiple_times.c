...
void test_BuildTbl_idx_0xFF_MSB_toggles_multiple_times(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0x90)), (UNITY_INT)(UNITY_UINT8 )((Crc8Tbl_u8[0xFF])), (
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_0xFF_MSB_toggles_multiple_times.c" 3 4
 ((void *)0)
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_0xFF_MSB_toggles_multiple_times.c"

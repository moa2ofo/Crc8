...
void test_BuildTbl_idx_0_lower_boundary(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0x00)), (UNITY_INT)(UNITY_UINT8 )((Crc8Tbl_u8[0])), (
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_0_lower_boundary.c" 3 4
 ((void *)0)
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_0_lower_boundary.c"

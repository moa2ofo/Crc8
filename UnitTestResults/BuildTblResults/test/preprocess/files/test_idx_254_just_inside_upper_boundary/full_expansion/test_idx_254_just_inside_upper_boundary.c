...
void test_BuildTbl_idx_254_just_inside_upper_boundary(void) {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8 )((0x97)), (UNITY_INT)(UNITY_UINT8 )((Crc8Tbl_u8[254])), (
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_254_just_inside_upper_boundary.c" 3 4
 ((void *)0)
# 15 "utExecutionAndResults/utUnderTest/test/test_idx_254_just_inside_upper_boundary.c"

...
void test_Crc8_Upd_u8_table_init_verification(void) {
  ...
  CalcByte_u8_CMockExpectAndReturn(18, crc, dataByte, 0x54);
...
# 23 "utExecutionAndResults/utUnderTest/test/test_table_init_verification.c" 3 4
 ((void *)0)
# 23 "utExecutionAndResults/utUnderTest/test/test_table_init_verification.c"

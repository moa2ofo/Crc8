...
# 42 "utExecutionAndResults/utUnderTest/src/EnsureTblInit.h"
...
void BuildTbl_CMockExpect(UNITY_UINT cmock_line);
...
void test_InitFlg_false_triggers_BuildTbl_and_sets_flag(void) {
  Crc8TblInitFlg_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_InitFlg_false_triggers_BuildTbl_and_sets_flag.c" 3 4
                    0
# 13 "utExecutionAndResults/utUnderTest/test/test_InitFlg_false_triggers_BuildTbl_and_sets_flag.c"
                         ;
  ...
  do { if ((Crc8TblInitFlg_b)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((19))); } } while (0);
}

...
void test_InitFlg_true_does_not_trigger_BuildTbl(void) {
  Crc8TblInitFlg_b = 
# 13 "utExecutionAndResults/utUnderTest/test/test_InitFlg_true_does_not_trigger_BuildTbl.c" 3 4
                    1
# 13 "utExecutionAndResults/utUnderTest/test/test_InitFlg_true_does_not_trigger_BuildTbl.c"
                        ;

  EnsureTblInit();

  do { if ((Crc8TblInitFlg_b)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((17))); } } while (0);
}
